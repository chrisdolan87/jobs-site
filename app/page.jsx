            ...
            <div className="max-w-6xl mx-auto py-16 flex flex-col gap-8">
                ...
                <div className="flex justify-between gap-8">
                    ...
                    <div className="min-h-96 min-w-80 w-1/3 p-8 text-center bg-[url('/mechanic-using-laptop.jpg')] bg-blend-overlay bg-center bg-cover rounded-2xl" style={{ backgroundColor: "#00242Aaa" }}>
                        <p className="text-2xl text-white font-bold mb-2">Expand Your Small Business</p>
                        <p className="text-white text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam iste modi aliquid doloremque, necessitatibus voluptatem voluptate iure ducimus asperiores eaque optio blanditiis animi corporis incidunt distinctio dolorem et fugit veritatis maiores, ipsa aut? Officiis, omnis!</p>
                    </div> 
